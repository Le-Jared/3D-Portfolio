...
import { BsGithub, BsDiscord, BsLinkedin, BsMedium } from "react-icons/bs";
...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      {/* 3D Model Container with pointer-events-none on mobile */}
      ...
      <div className="relative z-10">
          ...
          <div>
            <h1 className={`${styles.heroHeadText} text-white`}>
              ...
              <span className="animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent font-black">
                Jared <span className="hidden sm:inline">Lee</span>
              </span>
            </h1>
        ...
        {/* Social Icons */}
        <div className="absolute right-5 top-1/2 -translate-y-1/2 flex flex-col gap-5 items-center md:mt-10 mt-5 md:gap-12 z-20">
          <Link target="_blank" to="https://www.linkedin.com/in/le-jared/">
            <BsLinkedin
              size={30}
          ...
          <Link target="_blank" to="https://github.com/Le-Jared">
            <BsGithub
              size={30}
